...
class AbstractControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        file_put_contents($views_path . $php_name, "<?php echo '" . self::EXPECT_CONTENT . "';?>");
        ...
        file_put_contents($new_views_path . $php_name, "<?php echo '" . self::EXPECT_CONTENT . "';?>");
    ...
    {
        $this->assertEquals(self::EXPECT_CONTENT, AbstractController::render('index1'));
        $this->assertEquals(self::EXPECT_CONTENT, AbstractController::render('index2'));
    }

    function testRenderWithSubDir(): void
    {
        $this->assertEquals(self::EXPECT_CONTENT, AbstractController::render('test.index1'));
        $this->assertEquals(self::EXPECT_CONTENT, AbstractController::render('test.index2'));
    }
}
